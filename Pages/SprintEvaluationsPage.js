    ...
    render() {
        return (
            <div style = {this.props.style} class = "tableDiv">
                {(this.state.Ready === "true") && <SprintEvaluationsTable SprintEvaluations = {this.state.SprintEvaluations} onEvaluationsButton = {[this.props.onEvaluationsButton, this.goToEvaluations]} />}
